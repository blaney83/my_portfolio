...
class Sidebar extends React.Component {
    state = {
        ...
        networkType: window.navigator ? window.navigator.connection.effectiveType : "Protected",
        networkGHZ: window.navigator ? window.navigator.connection.downlink : "Protected",
