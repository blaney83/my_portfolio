...
var cloudChart = {
    ...
    animation: {
        ...
        draw: function (data) {
            cloudChart.animation.seq++;
            if (data.type === 'line') {
                // If the drawn element is a line we do a simple opacity fade in. This could also be achieved using CSS3 animations.
                data.element.animate({
                    opacity: {
                        // The delay when we like to start the animation
                        begin: cloudChart.animation.seq * cloudChart.animation.delays + 1000,
                        // Duration of the animation
                        dur: cloudChart.animation.durations,
                ...
                data.element.animate({
                    y: {
                        begin: cloudChart.animation.seq * cloudChart.animation.delays,
                        dur: cloudChart.animation.durations,
                        from: data.y + 100,
                        to: data.y,
